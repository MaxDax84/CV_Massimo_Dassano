...
const homeT = {
  it: {
    ...
    contact: {
      ...
      tipo_options: ["Diagnosi sito esistente", "Restyling sito esistente", "Nuovo sito web", "Sito completo", "Non so ancora, voglio informazioni"],
      messaggio: "Messaggio",
  ...
  en: {
    ...
    contact: {
      ...
      tipo_options: ["Website diagnosis", "Restyling existing site", "New website", "Complete website", "Not sure yet, I want information"],
      messaggio: "Message",
