...
const homeT = {
  it: {
    ...
    contact: {
      ...
      tipo_options: ["Diagnosi sito esistente", "Restyling sito esistente", "Nuovo sito web di presenza online", "Nuovo sito web completo", "Non so ancora, voglio informazioni"],
      messaggio: "Messaggio",
  ...
  en: {
    ...
    contact: {
      ...
      tipo_options: ["Website diagnosis", "Restyling existing site", "New online presence website", "New complete website", "Not sure yet, I want information"],
      messaggio: "Message",
